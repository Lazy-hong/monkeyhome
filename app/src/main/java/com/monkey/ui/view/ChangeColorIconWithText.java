...
public class ChangeColorIconWithText extends View {
    ...
    private  String mText="猿人";
    private  int mText_size= (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,12,getResources().getDisplayMetrics());
           ...
           int attr=a.getIndex(i);
            switch(attr){
                ...
                case R.styleable.ChangeColorIconWithText_text_size:
                    mText_size= (int) a.getDimension(attr,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,12,getResources().getDisplayMetrics()));
                break;
            }
        }
        a.recycle();
